...
export default function FindCompanies() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-extrabold text-slate-900">Verified Companies & Buyers</h1>
        <p className="text-xs text-slate-500 mt-1">
          Find verified food processors, exporters, and wholesale buyers across India.
        </p>
      </div>
      ...
      <div className="bg-white p-4 sm:p-5 rounded-2xl border border-slate-200/80 shadow-sm space-y-3">
        <div className="flex flex-col md:flex-row items-center gap-3">
          ...
          <div className="flex flex-wrap items-center gap-2 w-full md:w-auto">
            ...
            >
              <option value="all">Any Demanded Crop</option>
