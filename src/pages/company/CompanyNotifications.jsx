  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-extrabold text-slate-900">Procurement Alerts & Notifications</h1>
          <p className="text-xs text-slate-500 mt-0.5">
            Real-time notifications on new farmer crop arrivals, trade proposals, and messages.
          </p>
        </div>
      ...
      {notifications.length === 0 ? (
        <EmptyState
          ...
          description="When farmers list crops matching your demands or respond to offers, you'll receive real-time alerts here."
        />
      ) : (
